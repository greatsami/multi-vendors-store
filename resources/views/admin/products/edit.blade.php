                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('uploads/products/'.$product->thumb_image) }}" width="200" />
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sub_category" class="form-control sub-category">
                                                ...
                                                @foreach($subCategories as $subCategory)
                                                    <option value="{{ $subCategory->id }}" @selected(old('category', $product->sub_category_id) == $subCategory->id)>{{ $subCategory->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="child_category" class="form-control child-category">
                                                ...
                                                @foreach($childCategories as $childCategory)
                                                    <option value="{{ $childCategory->id }}" @selected(old('category', $product->child_category_id) == $childCategory->id)>{{ $childCategory->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="qty" min="0" value="{{ old('qty', $product->qty) }}" class="form-control" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_type" class="form-control">
                                        ...
                                        <option value="top_product" @selected(old('roduct_type', $product->roduct_type) == 'top_product')>Top Product</option>

    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $deleteBtn = "<a href='".route('vendor.product-variant-items.destroy', $query->id)."' class='btn btn-danger delete-item ml-2'><i class='far fa-trash-alt'></i></a>";
            ...
            ->addColumn('is_default', function ($query) {
                return $query->is_default == '1' ? '<i class="badge badge-success">Default</i>' : '<i class="badge badge-danger">No</i>';
            })

...
class ProductVariantItemController extends Controller
{
    ...
    public function index(ProductVariantItemDataTable $dataTable, $productId, $variantId)
    {
        ...
        return $dataTable->render('admin.products.variant-items.index', compact('product', 'variant'));
    }
    ...
    public function create($productId, $variantId)
    {
        $product = Product::findOrFail($productId);
        $variant = ProductVariant::findOrFail($variantId);
        return view('admin.products.variant-items.create', compact('product', 'variant'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.product-variant-items.index', ['productId' => $request->product_id, 'variantId' => $request->variant_id]);
    }
    ...
    {
        return view('admin.products.variant-items.edit', compact('productVariantItem'));
    }
